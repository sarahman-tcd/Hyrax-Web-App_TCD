set :stage, :digcollhyrax01
set :rails_env, :digcollhyrax01
set :branch, "sr_live"
...
server "digcoll-hyrax01.tcd.ie", user: "hyraxuser", roles: %w{app db web}
...
#before 'deploy:check', 'rvm:install_rvm'
