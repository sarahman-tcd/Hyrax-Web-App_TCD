...
ActiveRecord::Schema.define(version: 20260909100000) do
  ...
  create_table "doi_blocker_lists", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci" do |t|
    t.string "object_id"
    t.text "description"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "ingests", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    t.string "parent_id", default: "", null: false
    t.string "image_type", default: "", null: false
